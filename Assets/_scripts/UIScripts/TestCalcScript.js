...
enum zielPost {UP,DOWN,LEFT,RIGHT};
var pos : zielPost;
...
function DrawCompass(pos : zielPost){
	switch(pos){
		case zielPost.LEFT:
			print("isLeft");
		...
		case zielPost.DOWN:
			print("isDown");
			compassScreenPos.x = Mathf.Clamp(dIPClamped.x,35,Screen.width-35);
			compassScreenPos.y = dIPClamped.y+35;
			break;
		case zielPost.RIGHT:
			print("isRight");
			compassScreenPos.x = rIPClamped.x-35;
			compassScreenPos.y = Mathf.Clamp(rIPClamped.y,35,Screen.height-35);
			break;
	}
}